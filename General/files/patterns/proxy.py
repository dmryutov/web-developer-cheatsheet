...
img.fill('gray')  # Заливка цветом gray
img.draw(0, 0, 'green')  # Рисуем точку; координаты: (0, 0); цвет: green
img.draw(0, 1, 'green')  # Рисуем точку; координаты: (0, 1); цвет: green
img.draw(1, 0, 'green')  # Рисуем точку; координаты: (1, 0); цвет: green
img.draw(1, 1, 'green')  # Рисуем точку; координаты: (1, 1); цвет: green
img.save('image.png')  # Сохраняем изображение в файл image.png