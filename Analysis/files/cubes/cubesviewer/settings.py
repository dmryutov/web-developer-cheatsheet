...
DATABASES = {
    'default': {
        ...
        'NAME': '/db/cubesviewer.sqlite',  # Or path to database file if using sqlite3.
...
CUBESVIEWER_CUBES_URL = os.environ.get('CUBES_URL')
...
CUBESVIEWER_BACKEND_URL = os.environ.get('CUBESVIEWER_BACKEND_URL')
